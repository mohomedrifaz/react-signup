            ...
            <div className="setup-container">
                <div className="content-title">
                    ...
                    <div className="verficiation-content">
                        ...
                        <p className="email-address-verification">{formData.email}</p>
                    </div>
                    ...
                    <div className="verification-instructions-mobile">
                        <p>Please check your inbox, including your SPAM folder for an email from
                            <u> no-reply@v2cloud.com</u> with the subject "Verify your email address - V2 Cloud,"
                            and enter the verification code below to verify your email address;
                            the code will expire in 20 minuites.
                        </p>
                    </div>
