...
const SelectCountry = ({ flag, city, country, signal, onClick, isSelected, strength }) => {

    console.log('strength', strength);
    console.log('strength', country);
    ...
    const signalStrength = {
        ...
        poor: `<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.5 0C12.0078 0 12.4375 0.429688 12.4375 0.9375V11.5625C12.4375 12.1094 12.0078 12.5 11.5 12.5C10.9531 12.5 10.5625 12.1094 10.5625 11.5625V0.9375C10.5625 0.429688 10.9531 0 11.5 0ZM6.5 3.75C7.00781 3.75 7.4375 4.17969 7.4375 4.6875V11.5625C7.4375 12.1094 7.00781 12.5 6.5 12.5C5.95312 12.5 5.5625 12.1094 5.5625 11.5625V4.6875C5.5625 4.17969 5.95312 3.75 6.5 3.75ZM1.5 7.5C2.00781 7.5 2.4375 7.92969 2.4375 8.4375V11.5625C2.4375 12.1094 2.00781 12.5 1.5 12.5C0.953125 12.5 0.5625 12.1094 0.5625 11.5625V8.4375C0.5625 7.92969 0.953125 7.5 1.5 7.5Z" fill="#DC6803"/>
        </svg>`
    }
    ...
    return (
        <div className={`country-select ${isSelected ? "selected" : ""}`}
            ...
            <div className="section-2">
                <div className="signal-bar" dangerouslySetInnerHTML={{ __html: signalStrength["full"] }}></div>
