...
const SelectCountry = ({ flag, city, country, signal, onClick, isSelected }) => {

    // const handleCardSelection = () => onClick();
            ...
            <div className="section-2">
                ...
                <div className="select-checkbox">
                    ...
                    <div className="checkbox-icon">
                        <svg width="34" height="32" viewBox="0 0 32 34" fill="none" xmlns="http://www.w3.org/2000/svg">
