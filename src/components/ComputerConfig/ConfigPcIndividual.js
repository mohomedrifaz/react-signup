...
const ConfigPcIndividual = ({ formData, setFormData, stepData: { nextStep }, appData }) => {
    ...
    const networkcards = [
        ...
        },
        {
            ...
            subTitle: `$${appData.public_ip[`${formData.contract_type}_contract`]}/month`,
            content: 'Your instance wil be on a public IP address & will be exposed to the internet (Less secure)',
            recommended: false,
        }
    ];

    const backups = Object.entries(appData.backup_retention[`${formData.contract_type}_contract`]).map(([key, value]) => {
        ...
        <>
            ...
            <div className="config-pc-container">
                    ...
                    <div className="name-password-input-fields">
                        ...
                        <div className="form-row-colfull col2">
                            ...
                            <div className="password-container">
                                ...
                                <button className="regenerate-pass" onClick={handleRegeneratePassword}>
                    ...
                    <div className="backups-container">
                        {backups.map((backup, index) => (
                            <ConfigCards key={index} logo={backup.logo} mainTitle={backup.mainTitle}
                                ...
                                isSelected={formData.bck_retention?.value === backup.days}
                                onClick={() => {
                                    setFormData({
                                        bck_retention: {
                ...
                {!isBusiness && <div className="enable-businessplan-infobox">
                    ...
                    <button className="button" onClick={gotoPlans}>
